...
<html lang="es">
  <head>
    ...
    <title>Verano en Hacienda del Cardenal | La Hacienda del Cardenal, Toledo</title>
...
<link href="/engine.css" rel="stylesheet">
  ...
  <body><div id="miraiTracking" data-mirai-engine="mirai_tr" data-idhotel="" data-init="auto"></div>
    ...
    <div class="jumbotron no-margin-padding bg-white">
    	<div class="container">
        <h1 class="text-center">Verano en Hacienda del Cardenal</h1>
    		<div class="row">
        		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center">
                <p>&nbsp;</p>
<h3><strong>Queridos amigos:</strong></h3>
<p><strong>Este verano estaremos abiertos:</strong></p>
<p>&nbsp;</p>
<p><strong>Comidas y cenas:</strong> Jueves, Viernes y Sábados
<br><br><strong>Comidas:</strong> Domingo (hasta las 18.30h)
</p>
<p>Podéis hacer vuestras reservas y peticiones en <a href="mailto:restaurante@haciendadelcardenal.com" title="Reserva día y hora">restaurante@haciendadelcardenal.com</a> y en nuestro teléfono 925 220862.</p>
<p>&nbsp;</p>
<p><strong>¡Os esperamos este verano en Cardenal!</strong></p>

            	</div>

                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
<img src="images/QR-Hacienda-del-Cardenal-2021.png" alt="QR a la carta del restaurante" class="img-responsive center-block">
<p>&nbsp;</p>
